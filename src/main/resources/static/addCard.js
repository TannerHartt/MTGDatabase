...
function PrevImage() {
    switch (frameArtSm.src.split("0/")[1]) {
        ...
        case "cardart2.jpg":
            ...
            break;
        case "cardart1.jpg":
            frameArt.src="http://agamedesigner.info/nissa.jpg";
            frameArtSm.src="http://agamedesigner.info/nissa.jpg";
            cardImageText.value="nissa.png"
            break;
...
function NextImage() {
    switch (frameArtSm.src.split("0/")[1]) {
        ...
        case "cardart11.jpg":
            frameArt.src="http://agamedesigner.info/nissa.jpg";
            frameArtSm.src="http://agamedesigner.info/nissa.jpg";
            cardImageText.value="http://agamedesigner.info/nissa.jpg";
            break;
